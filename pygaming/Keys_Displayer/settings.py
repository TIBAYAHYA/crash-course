...
class Settings:
    def __init__(self):
        self.width = 1000
        self.height = 600
        self.background_color = (128, 215, 67)
        self.font = pygame.font.SysFont("Comic Sans MS", 72)
        
        # this big dictionary was generated by ai, It should allow me to transform pygame interpreted keys to 
        #a format that a human can easily understand
        self.key_name_map = {
