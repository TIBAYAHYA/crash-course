...
class Bullets(Sprite):
    def __init__(self,ai_game):
        ...
        self.bullet_rect.midright = ai_game.ship.rect.midright
    ...
    def update(self):
        self.x += self.settings.bullet_speed #bullet heading upwards
        self.bullet_rect.x = self.x #change bullet location
